    ...
    data: {
      ...
      workflows: [
        ...
        },
        {
          ...
          // `wf_5e5ad3b6f7da4299a839` on 2026-09-22, five independent steps and
          // a sixth joining all five through `input_from`. The old view drew
          // this as five boxes, one `THEN` bar and one box -- the identical
          // marks a chain of five draws -- and the dependency line that would
          // have disambiguated it was ellipsed at `allorn...`.
          //
          // It is in the fixture because a development set whose only workflow
          // is a two-way join never shows the case that was got wrong. No step
          // carries a task id: this is a workflow the scheduler has not reached,
          // which is a real state, and it keeps the fixture honest -- inventing
          // six task documents to colour it in would be a fixture agreeing with
          // itself.
