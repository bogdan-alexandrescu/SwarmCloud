    ...
    <section className="section panel">
      <h2>
        {/* `.section > h2` uppercases, and this is an identifier: the string
            ...
            every id on every screen, so it now lives once as `.ident`; the
            workflow heading had the identical defect and was NOT fixed by an
            override that only one file knew about. */}
        <span className="ident">{runtime.name}</span>
