...
WHY_NOT: dict[tuple[Tier, str], str] = {
    ...
    (Tier.IMPERSONATE, "team"): (
        ...
        "terraform/environments/<env>/<env>.tfvars, which today lists only "
        "domain:saga.xyz and therefore no service account. Until that grant lands "
        "this tier cannot read a team deployment. SWARM_IAP_CLIENT_ID is NOT the "
