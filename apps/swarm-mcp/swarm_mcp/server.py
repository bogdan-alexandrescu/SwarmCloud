...
TOOLS: list[dict[str, Any]] = [
    ...
    # work happens.
    {
        ...
        "description": (
            ...
            "SwarmCloud tells each upstream agent which filenames its dependants "
            "stage and the absolute path of $SWARM_ARTIFACTS_DIR, which is "
            "outside the repository, so a file it writes anywhere else never "
            "reaches them. Every "
