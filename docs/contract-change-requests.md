...
| 13 | `identity.py`: the tenant namespace name, `sanitize_name` included, has two copies | open |
...
## 13. `identity.py`: the tenant namespace name, `sanitize_name` included, has two copies
